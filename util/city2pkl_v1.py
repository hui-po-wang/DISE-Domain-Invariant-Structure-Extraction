...
root = '/home/wilson/dataset/Cityscapes'
...
def transform(img, lbl):
    ...
    img -= mean
    img = m.imresize(img, (img_size[0], img_size[1]), 'bicubic')
...
for split in ['train', 'val', 'test']:
    ...
    annotations_base = os.path.join(root, 'gtFine_trainvaltest', 'gtFine', split)
...
with open('city_data.pkl', 'wb') as f:
    pkl.dump({ 'train': {'images': X['train'], 'labels': Y['train']},
               ...
               'test' : {'images': X['test'] , 'labels': Y['test']},
